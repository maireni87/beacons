...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Property.yelp_scraped'
        db.add_column(u'app_property', 'yelp_scraped',
    ...
    def backwards(self, orm):
        # Deleting field 'Property.yelp_scraped'
        db.delete_column(u'app_property', 'yelp_scraped')
