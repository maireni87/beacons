...
def scrape(num_pages=31):
    ...
    for page_num in range(1, num_pages + 1):
        ...
        soup = BeautifulSoup(requests.get(url).text, 'html5lib', 'lxml')
...
if __name__ == "__main__":
    ...
    with open('beaconscraper.txt', 'rb') as f:
    ...
    print "writing out beaconscraper.txt"

    today_prices = { 'AAPL' : 90.91, 'MSFT' : 41.68, 'FB' : 64.5 }

    with open('beaconscraper.txt','wb') as f:
